...
终于知道为什么乐队开始前为什么先打2下,再打同样时值的4下,前两下建立一拍的时值,后面4拍建立1/2拍的时值,实际上这时候四分之拍你也随时就建立了.时值确定是需要逐步细分人才能准确接得住.也有前面2下,后面3下,其实第4下省略了,人脑能补充,我猜测是不是也考虑到第4下有可能会在正式录音的时候录进去,不知道是不是这样 ?   #弹琴
