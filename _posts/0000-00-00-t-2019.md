...
又一个线上学院 ![https://www.udemy.com/](https://www.udemy.com/)
...
An example of gin
![https://github.com/eddycjy/go-gin-example](https://github.com/eddycjy/go-gin-example)
...
以后做个医生好不好,不做,做个吉他手呢?不做!做个程序员呢?不做程序员! 做个开钻机的好吗?好!!!!! #米果
...
lime项目 ![https://github.com/limetext/lime](https://github.com/limetext/lime)
...
计算机科学速成课  ![https://www.bilibili.com/video/av21376839/](https://www.bilibili.com/video/av21376839/)
...
<hr>
F12是最后一个窗口,option+F12是终端,无论在哪Esc都回到编辑器窗口,还是jetbrains的工程师懂工程师
...
<hr>
我们熟悉一个东西的使用,重点不是掌握了更多的信息,而是如何剔除无用信息,再处理剩下的有用信息. #方法论
