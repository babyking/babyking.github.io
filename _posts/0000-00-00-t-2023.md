...
Logic pro中的自动化 Read / Touch / Latch / Write 四种模式, touch跟cubase中的write一致, latch与touch的区别就是最后调整的数据值会一直延续覆盖后续的数值,有点像ADSR中的S. write则是用于复位数据,跟cubase中的write不同. 总之logic中的这个概念要复杂些. #logic
